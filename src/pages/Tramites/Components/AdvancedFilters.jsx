    ...
    () => [
      {
        ...
        type: 'text',
        label: 'Buscar',
        placeholder: 'Placa, titular, documento, chasis, VIN...',
        showSearchIcon: true,
        width: 6,
      },
      {
...
export default TramitesFilters;
