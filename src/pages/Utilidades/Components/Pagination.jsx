...
const Pagination = ({
  ...
  const handleFirstPage = () => {
    if (onPageChange && canGoPrevious) onPageChange(0);
  };

  const handlePreviousPage = () => {
    if (onPageChange && canGoPrevious) onPageChange(page - 1);
  };

  const handleNextPage = () => {
    if (onPageChange && canGoNext) onPageChange(page + 1);
  };

  const handleLastPage = () => {
    if (onPageChange && canGoNext) onPageChange(totalPages - 1);
  };
