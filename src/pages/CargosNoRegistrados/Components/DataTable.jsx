...
// ============================================
// CargosNoRegistrados Columns Configuration
// ============================================
const columns = [
...
// ============================================
// CargosNoRegistradosDataTable Component
// ============================================
const CargosNoRegistradosDataTable = ({
  data,
  loading = false,
  page = 0,
  pageSize = 25,
  ...
  onEdit,
  onDelete,
  emptyMessage = 'No se encontraron cargos no registrados',
  stickyHeader = true,
  maxHeight = 600,
  showActions = true,
}) => {
...
export { columns };
export default CargosNoRegistradosDataTable;
