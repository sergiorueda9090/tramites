...
const RecepcionPagoDialog = ({
  open,
  onClose,
  onSave,
  selectedRecepcionPago,
  form,
  onFormChange,
  clientes = [],
  tarjetas = [],
}) => {
  const isEditing = !!selectedRecepcionPago;
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <DialogTitle>
        {isEditing ? 'Editar recepción de pago' : 'Nueva recepción de pago'}
      </DialogTitle>
      <DialogContent>
      ...
      <DialogActions>
        ...
        <Button variant="contained" onClick={onSave}>
          {isEditing ? 'Guardar cambios' : 'Crear recepción'}
        </Button>
      </DialogActions>
    </Dialog>
  );
...
export default RecepcionPagoDialog;
