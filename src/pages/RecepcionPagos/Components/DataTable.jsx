...
// ============================================
// RecepcionPagos Columns Configuration
// ============================================
const columns = [
...
// ============================================
// RecepcionPagosDataTable Component
// ============================================
const RecepcionPagosDataTable = ({
  data,
  loading = false,
  page = 0,
  pageSize = 25,
  ...
  onEdit,
  onDelete,
  emptyMessage = 'No se encontraron recepciones de pago',
  stickyHeader = true,
  maxHeight = 600,
  showActions = true,
}) => {
...
export { columns };
export default RecepcionPagosDataTable;
