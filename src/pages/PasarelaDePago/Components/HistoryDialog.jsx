        ...
        {historyData.length === 0 ? (
          <Box sx={{ py: 4, textAlign: 'center' }}>
            <Typography color="text.secondary">
              No se encontraron cambios registrados para este registro.
            </Typography>
          </Box>
        ) : (
          <>
                    ...
                    return (
                      <TableRow key={entry.history_id} hover>
                        ...
                        <TableCell>
                          ...
                          <Typography variant="body2">
                            <strong>Grupo SOAT:</strong> {entry.grupo_soat || '-'} · <strong>Tarifa:</strong> {entry.tarifa_codigo || '-'}
                          </Typography>
                          <Typography variant="body2">
                            <strong>Estados:</strong> Trámite {ESTADO_LABEL(entry.tramite_estado)} · Confirmación {ESTADO_LABEL(entry.confirmacion_estado)} · PDF {ESTADO_LABEL(entry.cargar_pdf_estado)}
                          </Typography>
                        </TableCell>
                      </TableRow>
                    );
