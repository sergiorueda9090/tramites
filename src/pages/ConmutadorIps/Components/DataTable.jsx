...
// ============================================
// Columnas del listado del Conmutador de IPs
// ============================================
const columns = [
  ...
  },
  {
    ...
    renderCell: ({ value }) => (
      <Chip
        ...
        size="small"
        color={value === 'https' ? 'success' : 'default'}
        variant="outlined"
      />
    ),
  },
...
const ConmutadorIpsDataTable = ({
  ...
  onEdit,
  onDelete,
  emptyMessage = 'No se encontraron IPs registradas',
  stickyHeader = true,
  maxHeight = 600,
  showActions = true,
}) => {
...
export { columns };
export default ConmutadorIpsDataTable;
