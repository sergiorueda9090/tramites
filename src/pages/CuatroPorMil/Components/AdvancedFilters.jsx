...
const MODULO_OPTIONS = [
  { value: 'recepcion_pago',        label: 'Recepción de pagos' },
  ...
  { value: 'pasarela_de_pago',      label: 'Pasarela de pago' },
  { value: 'finalizados_tramites',  label: 'Trámites finalizados' },
];

const CuatroPorMilFilters = ({
  filters,
  activeFilters = [],
  onFilterChange,
  onApply,
...
export default CuatroPorMilFilters;
