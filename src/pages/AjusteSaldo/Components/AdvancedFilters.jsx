...
// ============================================
// AjusteSaldoFilters Component
// ============================================
const AjusteSaldoFilters = ({
  filters,
  activeFilters = [],
  clientes = [],
  onFilterChange,
  ...
  // Build filter config dynamically based on clientes data
  const filterConfig = useMemo(() => [
    {
      field: 'search',
      type: 'text',
      label: 'Buscar',
      placeholder: 'Cliente u observación...',
      showSearchIcon: true,
      width: 4,
    },
    {
...
export default AjusteSaldoFilters;
