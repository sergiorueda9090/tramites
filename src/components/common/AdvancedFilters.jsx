      ...
      case 'text':
        return (
          <TextField
            ...
            InputProps={{
              startAdornment: config.showSearchIcon ? <SearchIcon sx={{ mr: 1, color: 'text.secondary' }} /> : null,
            }}
          />
        );
        ...
        return (
          <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="es">
            <DatePicker
              ...
              onChange={(newValue) => handleFilterChange(config.field, newValue?.format('YYYY-MM-DD') || '')}
              slotProps={{
